...
class WorkSession(BaseMeeting):
    ...
    async def _run_agent_execution(self, agent: RegisteredAgent, context: str, tracker: CostTracker) -> str:
        ...
        system_prompt = (
            ...
            "- Initiative Rule: If your assigned tasks are complete or light, identify and execute "
            "3 actions within your expertise to produce something or improve BPR&D. Examples: "
            "write a research brief, fix a code issue, create a useful tool, improve documentation, "
            "optimize an existing process. Document ALL initiative actions in your output.\n\n"
            "Output Rules:\n"
