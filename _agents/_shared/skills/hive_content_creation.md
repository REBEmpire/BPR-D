...
### **The Scoop (Body)**
*   **Selection:** Pick 3-5 briefs from the day's research. Focus on:
...
2.  **Select Topics:** Choose the best stories.
3.  **Draft Post:** Create `publishing/hive/drafts/YYYY-MM-DD-hive-post.md`.
4.  **Request Images:** Create `publishing/hive/drafts/image_prompts.md` and run/request generation.
5.  **Review:** Verify tone and formatting.
